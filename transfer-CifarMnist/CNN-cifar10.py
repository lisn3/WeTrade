...
#X_train_data, y_train_data= mislabel(X_train, y_train, train_data_num, alp)
#X_train_data, y_train_data= noisydata(X_train, y_train, train_data_num, 0.8, 'gaussian', 0, alp)
#X_train_data, y_train_data= noisydata(X_train, y_train, train_data_num, alp, 'pepper')  #data missing
X_train_data, y_train_data= down_sample(X_train, y_train, train_data_num, alp, alp) #
#X_train_data, y_train_data= unmatch_data(X_train, y_train, alp,'cifar10','oxflower17') #
#X_train_data, y_train_data = unbalance(X_train, y_train, alp)
